...
<html>
	<head>
		<title>Eastern European track</title>
	...
	<body>
		...
		<main>
			<h2 class="track-heading">Welcome to the Eastern European track</h2>
			<section class="track-section1" id="easternbackground1">				
				<div class="info-block">
					<img src="img/easternpics/eastern1.jpg" alt="food" class="image-position">
				...
				<div class="info-block">
					...
					<img src="img/easternpics/eastern2.jpg" alt="food" class="image-position">
				</div>				
			</section>
			<section>
				<h2 class="track-heading">List of courses you can expect from this track</h2>
				<h3 class="subheading">mauris commodo</h3>
				...
				<h3 class="subheading">Tortor dignissim convallis</h3>
				...
				<h3 class="subheading">ultrices sagittis orci</h3>
				...
				<h3 class="subheading">voluptate velit esse</h3>
				...
				<h3 class="subheading">commodo nulla facilisi</h3>
			...
			<section class="track-section3" id="asianbackground2">
				...
				<span class="down-arrow" id="easternarrow">&dArr;</span>
