<?php
    ...
    if(!isset($_SESSION["valid_id"]) || !isset($_SESSION["valid_username"])){
		...
		require_once 'includes/conndb.php';
		 ...
		 $fetch = "SELECT student_code, first_name, last_name, telephone_number, email_address, users_name FROM student WHERE users_name ='$valid_user'";
		 ...
		 mysqli_stmt_bind_result($statement, $id, $firstName, $lastName,  $phone, $email, $usrn);
